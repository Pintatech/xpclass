-- Update achievement system to support manual claiming
-- Add claimed status to user_achievements table

ALTER TABLE public.user_achievements 
ADD COLUMN IF NOT EXISTS claimed_at timestamp with time zone,
ADD COLUMN IF NOT EXISTS xp_claimed integer DEFAULT 0;

-- Update the check_and_award_achievements function to not auto-award XP
...
-- Create function to claim achievement XP
